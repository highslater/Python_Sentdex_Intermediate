...
"""02_String_Concatination_and_Formatting.py.
...
'''
>>> help(__builtins__.open) BELOW v
'''

with open(os.path.join(location_of_file, file_name), 'rt') as f:
    print(f.read())
print("*" * 90)
...
print("{0} bought {1} apples today!".format(who, how_many))  # Python2

print("{} bought {} apples today!".format(who, how_many))
print("*" * 90)

'''
>>> help(__builtins__.open)
